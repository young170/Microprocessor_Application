...
LED_TOGGLE:
  ...
  AND R2, R1, #LED1_MASK // mask other bits as 0
  AND R3, R1, #LED2_MASK // mask other bits as 0
  EOR R2, R2, #LED1_MASK
  EOR R3, R3, #LED2_MASK
  ORR R1, R2, R3 // toggle all leds
  STR R1, [R0, #GPIO_OUT_OFFSET]
  MOV PC, LR
